# This script generates Figures 2(e) and 2(f) from the paper
...
# Stability Selection with Gram-Schmidt process
...
tmp_df$Method[tmp_df$Method == "S1"] <- "Decorrelation" # Rename methods
...
metrics_results$Method[metrics_results$Method == 1] <- 'Decorrelation' # Rename methods
...
write.csv(results, "Gram_Full.csv", row.names = FALSE) # Save results to CSV file
