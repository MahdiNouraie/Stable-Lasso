# This script generates comparison of differenrt c values
...
# Stability Selection with Stable Lasso (c = 0.25)
...
# Stability Selection with Stable Lasso (c = 0.5)
time_taken <- system.time({results <- mclapply(1:100, function(i) {
  set.seed(26 + i) # Set seed for reproducibility
...
# Stability Selection with Stable Lasso (c = 1)
time_taken <- system.time({results <- mclapply(1:100, function(i) {
  set.seed(26 + i) # Set seed for reproducibility
...
# Stability Selection with Stable Lasso (c = 2)
time_taken <- system.time({results <- mclapply(1:100, function(i) {
  set.seed(26 + i) # Set seed for reproducibility
...
# Stability Selection with Stable Lasso (c = 4)
time_taken <- system.time({results <- mclapply(1:100, function(i) {
  set.seed(26 + i) # Set seed for reproducibility
...
tmp_df$Method[tmp_df$Method == "S1"] <- "c = 0.25" # Rename methods
tmp_df$Method[tmp_df$Method == "S2"] <- "c = 0.5" # Rename methods
tmp_df$Method[tmp_df$Method == "S3"] <- "c = 1" # Rename methods
tmp_df$Method[tmp_df$Method == "S4"] <- "c = 2" # Rename methods
tmp_df$Method[tmp_df$Method == "S5"] <- "c = 4" # Rename methods
...
metrics_results$Method[metrics_results$Method == 1] <- 'c = 0.25' # Rename methods
metrics_results$Method[metrics_results$Method == 2] <- 'c = 0.5' # Rename methods
metrics_results$Method[metrics_results$Method == 3] <- 'c = 1' # Rename methods
metrics_results$Method[metrics_results$Method == 4] <- 'c = 2' # Rename methods
metrics_results$Method[metrics_results$Method == 5] <- 'c = 4' # Rename methods
...
write.csv(results, "Comparison_cvalues_Full.csv", row.names = FALSE) # Save results to CSV file
